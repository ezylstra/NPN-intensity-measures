...
# Set response variable (log numeric values, keep percentages):
gamdf <- gamdf %>%
  mutate(resp = ifelse(intensity_type == "number",
...
summary(m2)
  ...
  # m2_new <- data.frame(fyr = NA, day_of_year = NA)
